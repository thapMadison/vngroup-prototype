...
(function (W) {
  ...
  A.P.order = {
    ...
    render: function () {
      ...
      if (o.payMethod === 'cash') info.push([L('Thanh toán', 'Payment'), '<span class="badge plain t-neutral">' + ic('money') + L('Tiền mặt', 'Cash') + '</span>' + (o.cashFail ? ' <span class="muted">' + L('chưa thu được', 'not collected') + '</span>' : '')]);
